...
export const projects: Project[] = [
  ...
  {
    slug: "csharp-aio-for-dummies",
    title: "C# 10.0 All-in-One For Dummies",
    shortDescription:
      "Comprehensive source code from C# 10.0 All-in-One For Dummies by John Paul Mueller. Covers 5 books spanning C# basics, OOP, advanced topics, web development, and Unity game development.",
    fullDescription: [
    ...
    githubUrl: "https://github.com/SwredObSecurity/CSharp-10.0-All-in-One-For-Dummies",
    displayUrl: "GitHub Repository",
    image: "/projects/csharp-aio-for-dummies.svg",
    tags: ["C#", ".NET", "OOP", "Comprehensive"],
    features: [
    ...
    techStack: ["C#", ".NET", "ASP.NET", "Visual Studio"],
    category: "Learning & Fundamentals",
  },
  {
    slug: "cpp-aio-for-dummies",
    title: "C++ All-in-One For Dummies",
    shortDescription:
      "Source code examples from C++ All-in-One For Dummies, 4th Edition by John Paul Mueller. Spans 7 books covering fundamentals, OOP, pointers, advanced C++, I/O, templates, and the STL.",
    fullDescription: [
    ...
    githubUrl: "https://github.com/SwredObSecurity/CPP-All-in-One-For-Dummies",
    displayUrl: "GitHub Repository",
    image: "/projects/cpp-aio-for-dummies.svg",
    tags: ["C++", "Systems Programming", "STL", "Comprehensive"],
    features: [
    ...
    techStack: ["C++", "STL", "GCC/G++"],
    category: "Learning & Fundamentals",
  },
  {
    slug: "web-coding-aio-for-dummies",
    title: "Web Coding & Development All-in-One",
    shortDescription:
      "Code examples from Web Coding & Development All-in-One For Dummies by Paul McFedries. Covers 7 books and 30+ chapters spanning HTML, CSS, JavaScript, jQuery, PHP, MySQL, APIs, and deployment.",
    fullDescription: [
      "A full collection of code examples from 'Web Coding & Development All-in-One For Dummies' by Paul McFedries. The repository spans 7 books with over 30 chapters, covering the complete web development stack from front-end to back-end.",
      "The books progress through HTML structure and semantics, CSS styling and layout, JavaScript programming and DOM manipulation, jQuery for rapid development, PHP and MySQL for server-side logic and databases, working with web APIs, and deployment strategies.",
      "This project provides a structured full-stack learning path with real, runnable code examples for every chapter — demonstrating how each technology layer connects to build complete web applications.",
    ],
    githubUrl: "https://github.com/SwredObSecurity/Web-Coding-and-Development-All-in-One-For-Dummies",
    displayUrl: "GitHub Repository",
    image: "/projects/web-coding-aio-for-dummies.svg",
    tags: ["HTML", "CSS", "JavaScript", "PHP", "Full-Stack"],
    features: [
      "7 books with 30+ chapters",
      "HTML structure and semantics",
      "CSS styling, layout, and responsive design",
      "JavaScript and DOM manipulation",
      "jQuery for rapid development",
      "PHP and MySQL back-end development",
      "Web APIs and deployment strategies",
    ],
    techStack: ["HTML", "CSS", "JavaScript", "jQuery", "PHP", "MySQL"],
    category: "Web Development",
  },
  {
    slug: "javascript-aio-for-dummies",
    title: "JavaScript All-in-One For Dummies",
    shortDescription:
      "Source code from JavaScript All-in-One For Dummies. A comprehensive guide covering modern JavaScript fundamentals, DOM manipulation, events, async programming, Node.js, and React.",
    fullDescription: [
    ...
    githubUrl: "https://github.com/SwredObSecurity/JavaScriptAIO-For-Dummies",
    displayUrl: "GitHub Repository",
    image: "/projects/javascript-aio-for-dummies.svg",
    tags: ["JavaScript", "Node.js", "React", "Comprehensive"],
    features: [
    ...
    techStack: ["JavaScript", "Node.js", "React", "HTML", "CSS"],
    category: "Web Development",
  },
];
